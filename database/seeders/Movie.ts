...
export default class extends BaseSeeder {
  public async run () {
    ...
    await Movie.createMany([
      ...
      { title: 'The Dark Knight', director: 'Christopher Nolan', releaseYear: 2008, imdbRating: 9.0 },
      ...
      { title: 'Inglourious Basterds', director: 'Quentin Tarantino', releaseYear: 2009, imdbRating: 8.4 },
      ...
      { title: 'The Godfather', director: 'Francis Ford Coppola', releaseYear: 1972, imdbRating: 9.2 },
